/*
gcc -I /home/yonel/project/include -I /home/yonel/project/include/postgresql/server -fpic -c s_imgs.c
gcc -I /home/yonel/project/include -I /home/yonel/project/include/postgresql/server -shared -o s_imgs.so s_imgs.o 
cp s_imgs.so /home/yonel/project/lib




CREATE OR REPLACE FUNCTION s_imgs( int[] ) 
RETURNS array[]
AS '/home/yonel/project/lib/s_imgs.so', 's_imgs'
LANGUAGE C STRICT;
*/
...
//int4_array_add
Datum s_imgs(PG_FUNCTION_ARGS);

PG_FUNCTION_INFO_V1(s_imgs);
